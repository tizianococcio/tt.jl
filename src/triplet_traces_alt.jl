...
"""
version that decreases detectors only if there is no spikes
"""
function sim_m_dins(weights::Matrix{Float64},
	...
	println("starting simulation v$SIM_VER [with traces, dins]")
